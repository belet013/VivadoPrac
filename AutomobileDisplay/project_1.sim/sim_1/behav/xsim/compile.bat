...
REM
REM Generated by Vivado on Fri Sep 12 22:56:18 -0700 2025
...
echo "xvlog --incr --relax -prj tb_Mirror_Display_1_vlog.prj"
call xvlog  --incr --relax -prj tb_Mirror_Display_1_vlog.prj -log xvlog.log
